...
auth_email="neonghost@posteo.com"                                       # The email used to login 'https://dash.cloudflare.com'
auth_method="token"                                 # Set to "global" for Global API Key or "token" for Scoped API Token
auth_key="IYmt-DtsGCH2Ydc6tWhrD8-M73gQOegvew4gqvuX"                                         # Your API Token or Global API Key
zone_identifier="e4bfcbb5574b108b3703894eba535a9a"                                  # Can be found in the "Overview" tab of your domain
record_name="banshee"                                      # Which record you want to be synced
ttl=3600                                            # Set the DNS TTL (seconds)
proxy="false"                                       # Set the proxy to true or false
sitename="BANSHEE"                                         # Title of site "Example Site"
